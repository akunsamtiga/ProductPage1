...
export default function BlogPost() {
  ...
  // Simulasi perhitungan waktu baca (misalnya 1 menit per 1000 karakter)
  const readingTime = Math.ceil(post.content.length / 1000);

  // Ambil 3 artikel lain sebagai artikel terkait (exclude artikel saat ini)
  ...
  return (
    <section className="px-6 lg:px-16 py-10 lg:py-16 bg-gray-50">
      ...
      >
        <motion.div 
          variants={fadeInUp}
          className="prose prose-lg prose-blue mb-12"
        >
          {/* Menggunakan dangerouslySetInnerHTML untuk konten HTML */}
